      ...
      <main>
        ...
        <div className="container d-flex gap-5 justify-content-center pt-5">
            <div className="d-flex gap-2 perfume-logo ">
              <img src={logoPZ} alt="pz-logo" className="pz-logo" />
            ...
            <form className="p-5">
              ...
              <h6>Don’t have an account? <span className="text-term"><Link className="text-decoration-none" to={"/auth/signup"}>Sign Up</Link> </span> </h6>
            </form>
          </div>
        </div>
      </main>
